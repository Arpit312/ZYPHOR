...
export async function callGemini({ system, content }) {
  ...
  const payload = {
    ...
    systemInstruction: system ? {
      role: "user", // Google Gemini uses role user for systemInstruction in some betas, but actually "system" is typically used. Or just use role: "model" if system isn't supported. 
      // Actually systemInstruction syntax is:
